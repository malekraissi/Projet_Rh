...
class UtilisateurController extends AbstractController
{
    ...
    /**
     * @return \Symfony\Component\HttpFoundation\JsonResponse
     * @Route("/info" , name ="affiche_info" , methods={"GET"})
     */
    public function AfficheInfo(Request $request, UtilisateurRepository $utilisateurRepository)
    {
        $email = $request->query->get('email');
        $Result = $utilisateurRepository->findOneBy(array('email' => $email));
    ...
    /**
     * @return Response
     * @Route("/recherche ", name="utilisateur_recherche", methods={"GET","POST"})
     */

    public function searchAction(Request $request, UtilisateurRepository $utilisateurRepository)
    {
        $utilisateurs = $utilisateurRepository->findAll();
       ...
       $utilisateurs = $utilisateurRepository->findBy(array('prenom' => $data));
        ...
        return $this->render('recherche.html.twig', ['utilisateurs' => $utilisateurs]);
}
